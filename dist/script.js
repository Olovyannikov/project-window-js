...
const timer = (id, deadline) => {
  ...
  const setClock = (selector, endtime) => {
    ...
    function updateClock() {
      ...
      days.textContent = addLeadZero(t.days);
      hours.textContent = addLeadZero(t.hours);
      minutes.textContent = addLeadZero(t.minutes);
      seconds.textContent = addLeadZero(t.seconds);
